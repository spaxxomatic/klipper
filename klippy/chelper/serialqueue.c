...
#define SQPF_SERIAL 0
#define SQPF_PIPE   1
#define SQPF_ENCODER_CONN 2
#define SQPF_NUM    3 //number of file descriptor polls
...
struct serialqueue *p_serialqueue = NULL;

struct serialqueue * __visible
get_serialqueue()
{
	return p_serialqueue;
}
...
{
    if (p_serialqueue != NULL){
        pabort("Cannot allocate more than one serial queue");
    }

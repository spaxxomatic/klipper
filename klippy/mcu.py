...
class MCU_stepper:
    ...
    def _build_config(self):
        ...
        cmd = "config_stepper oid=%d step_pin=%s dir_pin=%s min_stop_interval=%d invert_step=%d" % (
...
class MCU:
    ...
    def __init__(self, config, clocksync):
        ...
        self._ffi_lib.set_trace_level( self._printer.get_start_args().get("trace_comm_level"))
        self._move_count = 0
        self._stepqueues = []

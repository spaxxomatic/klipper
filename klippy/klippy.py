...
def main():
    ...
    opts.add_option("-t", dest="trace_comm_level",
                    help="Trace MCU communication")
    ...
    start_args['trace_comm_level'] = 0
    if options.verbose:
        debuglevel = logging.DEBUG
    if options.trace_comm_level:
        start_args['trace_comm_level'] = int(options.trace_comm_level)
